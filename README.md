...
### 70/30 Split
![Logistic Regression Confusion Matrix 70/30](images/Logistic_Regression_Confusion_Matrix_70_30.png)
![Naive Bayes Confusion Matrix 70/30](images/Naive_Bayes_Confusion_Matrix_70_30.png)

### 90/10 Split
![Logistic Regression Confusion Matrix 90/10](images/Logistic_Regression_Confusion_Matrix_90_10.png)
![Naive Bayes Confusion Matrix 90/10](images/Naive_Bayes_Confusion_Matrix_90_10.png)

## ROC Curves

### 70/30 Split
![ROC Curve 70/30](images/ROC_Curve_70_30.png)

### 90/10 Split
![ROC Curve 90/10](images/ROC_Curve_90_10.png)
